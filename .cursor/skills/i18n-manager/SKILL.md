...
This skill manages the internationalization of ethnographic content.

## Core Responsibilities:
* **Translation Audit:** Identify missing translations in region-specific JSON files.
...
* Prioritize cultural context and linguistic accuracy.
