...
* **Functional Logic:** Generate tests for pure functions in `src/lib/` (e.g., `toEthnographicGeo`, `normalizeCountyName`). See [references/standards.md](references/standards.md).
