...
### 1. ARIA & Standards
- **Standard Adherence:** Verify correct usage of `aria-label`, `role`, and other accessibility attributes. See [references/best-practices.md](references/best-practices.md).
